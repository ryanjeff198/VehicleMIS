        ...
        <body>
                ...
                <div class="carousel-container">
                    <div class="carousel">
                        ...
                        <div class="carousel-slide">
                            <img src="../img folder/pic1.jpg" alt="KLD Building 3">
                        </div>
                        <div class="carousel-slide">
                            <img src="../img folder/pic2.jpg" alt="KLD Building 4">
                        </div>
                    </div>
            ...
            <div class="advantages">
                <div class="advantage-box">
                    <i class='bx bx-menu-alt-right' style="background-color: rgba(0, 100, 0, 0.014);"></i>
